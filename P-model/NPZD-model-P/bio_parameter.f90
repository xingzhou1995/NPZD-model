...
real(kind=8) :: beta  = 0.5 !0.3                         ! Z excretion fraction
real(kind=8) :: gama  = 0.3 !0.3                         ! Regeneration of Z predation excretion (assuming no higher predator)
!real(kind=8) :: r     = 0.15  !/day                  ! P mortality rate
 real(kind=8) :: r     = 0.1 !0.01  !/day                  ! luo option
!real(kind=8) :: dd     = 1.0   !m^3/gC/day            ! Higher Predation on Z
real(kind=8) :: dd     = 0.2 !0.02  !/day                  !luo option
...
real(kind=8)  :: e     = 1 !(chen)0.6   ! mmol P/m            ! luo option
...
real(kind=8) :: lamda =  0.2     !0.6   !(umol N 1-1)-1                  ! Ivlev constant for grazing
...
!luo option
real(kind=8) :: gammap = 0.0 !0.01 ! /day                 ! phyto respiration coefficient
real(kind=8) :: gammaz = 0.0 !0.015! /day                 ! zoo   respiration coefficient
real(kind=8) :: gammat = 0.07                        ! exponential for temperature forcing
real(kind=8) :: dr     = 0.015! /day                 ! remineralization rate of detritus
real(kind=8) :: Gmax   = 0.5 !0.4   ! /day                 ! maximum grazing rate by Z
real(kind=8) :: sigmaP = 1 !0.5  ! (mmolC/m3)^-1        ! preference coefficient of Z on P
real(kind=8) :: sigmaD = 0.0!0.1  ! (mmolC/m3)^-1        ! preference coefficient of Z on D
