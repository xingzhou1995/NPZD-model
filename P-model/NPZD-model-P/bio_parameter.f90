...
real(kind=8) :: dd     =0.2 !0.2 !0.2 !0.02  !/day                  !luo option
...
real(kind=8)  :: e     = 0.1 !0.1 !0.1   !(Edward)   ! mmol P/m            ! luo option
...
real(kind=8) :: Gmax   = 0.5 !0.5!0.5  !0.5 !0.4   ! /day                 ! maximum grazing rate by Z
real(kind=8) :: sigmaP = 0.5 !0.5  ! (mmolC/m3)^-1        ! preference coefficient of Z on P
real(kind=8) :: sigmaD = 0.0!0.1!0.1  ! (mmolC/m3)^-1        ! preference coefficient of Z on D
