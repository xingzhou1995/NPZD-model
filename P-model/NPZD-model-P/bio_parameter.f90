...
real(kind=8) :: alphaT = 0.4 !0.004                     ! temperature correction coefficient on growth rate
real(kind=8) :: alphaI = 14.88e-7 !7.0!14.88e-7 ! mgC/mgCHL/s/W                        ! light parameter relate tothe slope of the light function
real(kind=8) :: betaI  = 4.25e-8  !0.0!4.25e-8  ! mgC (mgCHL s W)-1                       ! photo inhibition
real(kind=8) :: umax   = 4.25e-5  !5.10e-4!4.25e-5 ! mmol C(mgCHL s)-1                           ! maximum growth rate
real(kind=8) :: upmax  = 2.8 !2.8!2.8 !1.0 !2.8 ! /day                 ! maxium growth rate for P
real(kind=8) :: No     = 1.2 !0.8 !nutrient threshold for uptaking
