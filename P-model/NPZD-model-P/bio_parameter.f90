...
real(kind=8) :: Toptp     = 27.2 !18   ! centigrade           ! maximum phytoplankton growth rate optimal water temperature
real(kind=8) :: Toptz  = 1         !maximum zooplankton growth rate optimal water temperature
real(kind=8) :: Tmin   = 5.5
...
real(kind=8) :: upmax  = 1.1 !2.8!2.8 !1.0 !2.8 ! /day                 ! maxium growth rate for P
