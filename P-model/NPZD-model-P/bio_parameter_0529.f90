...
real(kind=8) :: alpha = 0.3                         ! Z growth efficiency
real(kind=8) :: beta  = 0.6 !0.7 !(Edward Chen)0.3                         ! Z excretion fraction
...
!real(kind=8) :: r     = 0.15  !/day                  ! P mortality rate
 real(kind=8) :: r     = 0.1!0.1!0.01 !0.1 !0.01  !/day                  ! luo option
...
!luo option
real(kind=8) :: gammap = 0.07!0.01 !0.01 ! /day                 ! phyto respiration coefficient
...
real(kind=8) :: dr     = 0.015!0.4!0.015!0.0017!0.015 !0.015! /day                 ! remineralization rate of detritus
real(kind=8) :: Gmax   = 0.4!0.6!0.4!0.4!0.5!0.4   ! /day                 ! maximum grazing rate by Z
real(kind=8) :: KZG    = 5.4                                    !half saturation grazing rate for zooplankton
real(kind=8) :: M_G    =  2.0                               !grazing rate power
real(kind=8) :: sigmaP = 0.5!1.0!0.5 !0.5  ! (mmolC/m3)^-1        ! preference coefficient of Z on P
real(kind=8) :: sigmaD = 0.1!0.05!0.1!0.1!0.1  ! (mmolC/m3)^-1        ! preference coefficient of Z on D
...
real(kind=8) :: alphaI = 2.5e-7!7.0!14.88e-7 !7.0!14.88e-7 ! mgC/mgCHL/s/W                        ! light parameter relate tothe slope of the light function
...
real(kind=8) :: upmax  = 5.4!2.8 !2.8!2.8 !1.0 !2.8 ! /day                 ! maxium growth rate for P
