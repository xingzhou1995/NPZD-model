...
!real(kind=8) :: r     = 0.15  !/day                  ! P mortality rate
 real(kind=8) :: r     = 0.1!0.0!0.1!0.01 !0.1 !0.01  !/day                  ! luo option
...
real(kind=8)  :: e     = 0.6!0.0071!0.6  !0.6   !0.6 !0.1  !(Edward)   ! mmol P/m            ! luo option
...
!luo option
real(kind=8) :: gammap = 0.15!0.07!0.07!0.01!0.01 !0.01 ! /day                 ! phyto respiration coefficient
...
real(kind=8) :: Gmax   = 0.6!0.0!0.6!0.4!0.5!0.4   ! /day                 ! maximum grazing rate by Z
...
real(kind=8) :: alphaI = 7.0!2.5e-7!7.0!14.88e-7 !7.0!14.88e-7 ! mmolC/mgCHL/s/W                        ! light parameter relate tothe slope of the light function
...
real(kind=8) :: upmax  = 1.0!2.8!2.8!5.4!2.8 !2.8!2.8 !1.0 !2.8 ! /day  !mmol C(mgCHL day)-1               ! maxium growth rate for P
real(kind=8) :: No     = 0.0!0.0!0.00144 !0.8 !nutrient threshold for uptaking
