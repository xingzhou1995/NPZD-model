...
real(kind=8) :: Toptp     = 27.2!18 !18   ! centigrade           ! maximum phytoplankton growth rate optimal water temperature
real(kind=8) :: Toptz  = 1
real(kind=8) :: Tmin   = 5.5         !maximum zooplankton growth rate optimal water temperature
real(kind=8) :: alphaTP = 0.004 !0.004                     ! temperature correction coefficient on growth rate
real(kind=8) :: alphaI = 7.0!14.88e-7 !7.0!14.88e-7 ! mgC/(mgCHLEinst^-1)m^2                        ! light parameter relate tothe slope of the light function
real(kind=8) :: betaI  = 0.0!4.25e-8  !0.0!4.25e-8  ! mgC (mgCHL s W)-1                       ! photo inhibition
real(kind=8) :: umax   = 2.4  !mgc/mgchl/h!4.25e-5  !2.4!5.10e-4!4.25e-5 ! mmol C(mgCHL s)-1                           ! maximum growth rate
