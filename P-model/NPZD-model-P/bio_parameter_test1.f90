...
!real(kind=8) :: r     = 0.15  !/day                  ! P mortality rate
 real(kind=8) :: r     = 0.0!0.01 !0.1 !0.01  !/day                  ! luo option
!real(kind=8) :: dd     = 1.0   !m^3/gC/day            ! Higher Predation on Z
real(kind=8) :: dd     = 0.2!0.2!1.7280 !0.2 !0.02  !/day                  !luo option
...
real(kind=8)  :: e     = 0.6!0.1728!0.6  !0.6   !0.6 !0.1  !(Edward)   ! mmol P/m            ! luo option
...
real(kind=8) :: Gmax   = 0.6!0.4!0.4!0.5!0.4   ! /day                 ! maximum grazing rate by Z
real(kind=8) :: KZG    = 1.0                                    !half saturation grazing rate for zooplankton
real(kind=8) :: M_G    =  1.0                               !grazing rate power
real(kind=8) :: sigmaP = 0.5!0.5 !0.5  ! (mmolC/m3)^-1        ! preference coefficient of Z on P
...
real(kind=8) :: alphaTP = 0.05 !0.004                     ! temperature correction coefficient on growth rate
real(kind=8) :: alphaI = 7.0!2.5e-7!14.88e-7 !7.0!14.88e-7 ! mgC/mgCHL/s/W                        ! light parameter relate tothe slope of the light function
