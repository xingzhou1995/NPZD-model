...
real(kind=8) :: beta  = 0.3 !0.7 !(Edward Chen)0.3                         ! Z excretion fraction
...
real(kind=8)  :: e     = 0.1   !(Edward)   ! mmol P/m            ! luo option
...
real(kind=8) :: Gmax   = 0.5  !0.5 !0.4   ! /day                 ! maximum grazing rate by Z
...
real(kind=8) :: upmax  = 1.0 !2.8 ! /day                 ! maxium growth rate for P
