...
real(kind=8)  :: e     = 3.0!3.0 !0.6   !0.6 !0.1  !(Edward)   ! mmol P/m            ! luo option
...
!luo option
real(kind=8) :: gammap = 0.015!0.01 !0.01 ! /day                 ! phyto respiration coefficient
real(kind=8) :: gammaz = 0.015!0.015 !0.015! /day                 ! zoo   respiration coefficient
real(kind=8) :: gammat = 0.10 !0.007                       ! exponential for temperature forcing
real(kind=8) :: dr     = 0.015 !0.015! /day                 ! remineralization rate of detritus
real(kind=8) :: Gmax   = 0.45!0.5!0.4   ! /day                 ! maximum grazing rate by Z
...
real(kind=8) :: alphaT = 0.008!0.004 !                     ! temperature correction coefficient on growth rate
real(kind=8) :: alphaI = 30e-7  !14.88e-7 ! mgC/mgCHL/s/W                        ! light parameter relate tothe slope of the light function
real(kind=8) :: betaI  = 30e-8       !4.25e-8  ! mgC (mgCHL s W)-1                       ! photo inhibition
real(kind=8) :: umax   = 6e-4 !3e-4   !4.25e-5!4.25e-5 ! mmol C(mgCHL s)-1                           ! maximum growth rate
