...
real(kind=8) :: transferlight = 1.0 ! 0.6  !1.0
!real(kind=8) :: A             = 0.864 !0.864 !10   !/d              ! diffusion coefficient
real(kind=8) :: A_N = 8.64!0.864!1e-5!0.01!864   !DIFFUSION COEEFICENT OF A 
real(kind=8) :: A_P = 8.64!0.864!1e-5!0.01!864  !DIFFUSION COEEFICENT OF P
real(kind=8) :: A_Z = 8.64!0.864!1e-5!0.01!864  !DIFFUSION COEFFICENT OF Z
real(kind=8) :: A_D = 8.64!0.864!1e-5!0.01!864 !DOFFUSION COEEFICENT OF D
end module
