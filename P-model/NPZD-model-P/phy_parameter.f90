...
real(kind=8) :: att_water=0.06!0.07 !/m water attenuation
real(kind=8) :: att_phyto=0.0!0.03!0.03 !mgchl^-1m^2 !phytoplankton attenuation
real(kind=8) :: att_detritus=0.0!0.2!0.2 !g*detritusC^-1/m^2 !detritus attenuation
real(kind=8) :: att_turbidity=0.0 !turbidity attenuation


real(kind=8) :: Wn   = 0.0 ! m/d                 !sinking velocity of N
real(kind=8) :: Wp   = 0.1987!0.6!0.04 !0.6 ! m/d                 !sinking velocity of N
real(kind=8) :: Wz   = 0.0 ! m/d                 !sinking velocity of N
real(kind=8) :: Wd   = 0.1987!0.6 !0.6 ! m/d                 !sinking velocity of N
...
real(kind=8) :: transferlight = 1.618!1.618!0.006!0.6 ! 0.6  !1.0
