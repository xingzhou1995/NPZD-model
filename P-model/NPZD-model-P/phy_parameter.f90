...
real(kind=8) :: A_N = 0.864   !DIFFUSION COEEFICENT OF A 
real(kind=8) :: A_P = 0.864  !DIFFUSION COEEFICENT OF P
real(kind=8) :: A_Z = 0.864  !DIFFUSION COEFFICENT OF Z
real(kind=8) :: A_D = 0.864 !DOFFUSION COEEFICENT OF D
end module
