...
real(kind=8) :: att_water=0.07!0.06!0.07 !/m water attenuation
...
real(kind=8) :: Wp   = 0.6!0.1987!0.6!0.04 !0.6 ! m/d                 !sinking velocity of N
real(kind=8) :: Wz   = 0.0 ! m/d                 !sinking velocity of N
real(kind=8) :: Wd   = 0.6!0.1987!0.6 !0.6 ! m/d                 !sinking velocity of N
...
real(kind=8) :: transferlight = 0.006!1.678!0.006!1.678!0.006!1.678!1.678!0.006!0.6 ! 0.6  !1.0
!real(kind=8) :: A             = 0.864 !0.864 !10   !/d              ! diffusion coefficient
real(kind=8) :: A_N = 864!0.864!0.864!1e-5!0.01!864   !DIFFUSION COEEFICENT OF A 
real(kind=8) :: A_P = 864!0.864!0.864!1e-5!0.01!864  !DIFFUSION COEEFICENT OF P
real(kind=8) :: A_Z = 864!0.864!0.864!1e-5!0.01!864  !DIFFUSION COEFFICENT OF Z
real(kind=8) :: A_D = 864!0.864!0.864!1e-5!0.01!864 !DOFFUSION COEEFICENT OF D
end module
